...
class translentor_currency_currency_stat {
    ...
    public function recalculate_order_stats($order_id) {
        ...
        $order_recalculated = get_post_meta($order_id, 'translentor_currency_order_stat_recalculated', true);
        ...
        foreach ($order_data as $key => $value) {
            $order_data[$key] = $translentor_currency->back_convert($value, $order_rate, $decimals);
        }
        $format = array(
            '%f',
            '%f',
        ...
        update_post_meta($order_id, 'translentor_currency_order_stat_recalculated', true);
    }
