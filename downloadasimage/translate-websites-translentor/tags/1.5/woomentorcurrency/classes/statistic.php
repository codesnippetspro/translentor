...
class translentor_currency_STATISTIC {

    private $table = 'translentor_currency_statistic';
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_translentor_currency_stat_redraw', function() {
            $scenario = intval(esc_url_raw($_REQUEST['scenario']));
    ...
    public function can_collect() {
        return get_option('translentor_currency_collect_statistic', 0);
    }
    ...
    public function get_label($scenario) {
        ...
        switch ($scenario) {
            case 1:
                $label = esc_html__('Currencies popularity', 'woomentor-currency');
                break;
            case 2:
                $label = esc_html__('Countries popularity', 'woomentor-currency');
                break;
        }
