...
function triggerHtmlEvent(t, e) {
    var n;
    document.createEvent ? ((n = document.createEvent("HTMLEvents")).initEvent(e, !0, !0), t.dispatchEvent(n)) : (((n = document.createEventObject()).eventType = e), t.fireEvent("on" + n.eventType, n));
}
jQuery(document).ready(function(){
    ...
    textColor: toast_text_color  // To change the background
			...
			jQuery(".goog-te-combo").val(t), (window.location = default_language);
			myStorage = window.localStorage;
			selected_img_src=myStorage.getItem('img_src');
