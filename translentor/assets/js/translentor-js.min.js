...
function triggerHtmlEvent(e, o) {
    var a;
    document.createEvent ? ((a = document.createEvent("HTMLEvents")).initEvent(o, !0, !0), e.dispatchEvent(a)) : (((a = document.createEventObject()).eventType = o), e.fireEvent("on" + a.eventType, a));
}
jQuery(document).ready(function () {
    ...
    if (
        ...
        (window.location = default_language),
        null != (selected_img_src = (myStorage = window.localStorage).getItem("img_src")))
    ) {
    ...
    console.log("URL:	" + window.location.href),
        jQuery(document).on("click", "a.lang-select", function (e) {
            myStorage.clear(), myStorage2.clear(), e.preventDefault();
