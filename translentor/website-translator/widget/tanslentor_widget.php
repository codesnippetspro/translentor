...
class translentor_elementor_widget extends \Elementor\Widget_Base
{
    ...
    public function get_script_depends() 
    {
        return [ 
			...
			'translentor-website-translator-toast'
...
if($settings['nav_style_location']==='right')
 ...
 <li <?php echo $this->get_render_attribute_string( 'ct-language' ); ?> style="<?php echo $location?>"><span
			<?php echo $this->get_render_attribute_string( 'drop_footer' ); ?>><?php \Elementor\Icons_Manager::render_icon( $settings['translator_icon'], [ 'aria-hidden' => 'true' ] ); ?><span>
							...
							foreach ( $settings[ 'language_settings' ] as $key=>$item ) 
							{
								...
								if( ! in_array( $item["choose_language"] , $selected ) )
								{
									...
									$this->add_render_attribute(
										'footer_manuallink'.$i,
										[
											'href'=> esc_url( $lang_url->get_url_for_language($code, false) ),
											'class' => ['lang-es','lang-select_footer'],
									...
									echo '<li '.$this->get_render_attribute_string('stilesnavalign').'>';
										...
										if( $settings['language_style'] === 'both' )
										{
											...
											{ 
												?>
				<a <?php echo wp_kses_post( $this->get_render_attribute_string( $repeater_setting__country ) ); 
				 echo $this->get_render_attribute_string('footer_manuallink'.$i);
				?>
					><?php echo esc_html($name); ?> <img <?php echo $this->get_render_attribute_string('footer_manualimg'.$i)?>></a>
				<?php
											}
											else
											{
				...
				<a <?php echo wp_kses_post( $this->get_render_attribute_string( $repeater_setting__country ) ); 
				echo $this->get_render_attribute_string('footer_manuallink'.$i);?>
				   ><img <?php echo $this->get_render_attribute_string('footer_manualimg'.$i)?>><?php echo esc_html($name); ?> </a>
				<?php
											}
										}
										elseif( $settings['language_style'] === 'both_short' )
				...
				<a <?php echo wp_kses_post( $this->get_render_attribute_string( $repeater_setting__country ) ); 
				echo $this->get_render_attribute_string('footer_manuallink'.$i);?>
					><?php echo strtoupper($code); ?> <img <?php echo $this->get_render_attribute_string('footer_manualimg'.$i)?>></a>
				<?php
											}
											else
											{
				...
				echo $this->get_render_attribute_string('footer_manuallink'.$i);
				?>
					><img <?php echo $this->get_render_attribute_string('footer_manualimg'.$i)?>><?php echo strtoupper($code);?> </a>
				<?php
											}
										}
										elseif( $settings['language_style'] === 'icon' )
				...
				echo $this->get_render_attribute_string('footer_manuallink'.$i);
				?>
					><img <?php echo $this->get_render_attribute_string('footer_manualimg'.$i)?>></a>
				<?php
										}
										elseif( $settings['language_style'] === 'short' )
										{
				...
				?>
					><?php echo strtoupper($code); ?><img style="display:none"
					<?php echo $this->get_render_attribute_string('footer_manualimg'.$i)?>></a>
				<?php
										}
										else
										{
			...
			<?php echo $this->get_render_attribute_string( 'drop' ); ?>><?php \Elementor\Icons_Manager::render_icon( $settings['translator_icon'], [ 'aria-hidden' => 'true' ] ); ?><span>
                ...
                <nav <?php echo $this->get_render_attribute_string( 'horizontal_nav' ); ?>>
                    <ul <?php echo $this->get_render_attribute_string( 'menu' ); ?>>
											...
											echo '<li '.$this->get_render_attribute_string('stilesnavalign').'>';
												...
												if( $settings['language_style'] === 'both' )
												{
													...
													{ 
														?>
                        <a <?php echo wp_kses_post( $this->get_render_attribute_string( $repeater_setting__country ) ); 
						 echo $this->get_render_attribute_string('manuallink'.$i);
						?>
                            ><?php echo esc_html($name); ?> <img <?php echo $this->get_render_attribute_string('manualimg'.$i)?>></a>
                        <?php
													}
													else
													{
                        ...
                        <a <?php echo wp_kses_post( $this->get_render_attribute_string( $repeater_setting__country ) ); 
						echo $this->get_render_attribute_string('manuallink'.$i);?>
                           ><img <?php echo $this->get_render_attribute_string('manualimg'.$i)?>><?php echo esc_html($name); ?> </a>
                        <?php
													}
												}
												elseif( $settings['language_style'] === 'both_short' )
                        ...
                        <a <?php echo wp_kses_post( $this->get_render_attribute_string( $repeater_setting__country ) ); 
						echo $this->get_render_attribute_string('manuallink'.$i);?>
                            ><?php echo strtoupper($code); ?> <img <?php echo $this->get_render_attribute_string('manualimg'.$i)?>></a>
                        <?php
													}
													else
													{
						...
						echo $this->get_render_attribute_string('manuallink'.$i);
						?>
                            ><img <?php echo $this->get_render_attribute_string('manualimg'.$i)?>><?php echo strtoupper($code);?> </a>
                        <?php
													}
												}
												elseif( $settings['language_style'] === 'icon' )
						...
						echo $this->get_render_attribute_string('manuallink'.$i);
						?>
                            ><img <?php echo $this->get_render_attribute_string('manualimg'.$i)?>></a>
                        <?php
												}
												elseif( $settings['language_style'] === 'short' )
												{
						...
						?>
                            ><?php echo strtoupper($code); ?><img style="display:none"
							<?php echo $this->get_render_attribute_string('manualimg'.$i)?>></a>
                        <?php
												}
												else
												{
...
<?php
		echo '<h6 style="color: transparent;background:  transparent;">hide</h6>';
					   ...
					   foreach($elementor_setting['translentor_lang'] as $lang_code)
					   {
						   if ( $elementor_setting['translentor-default-language'] != $lang_code ) {
							   $lang_query->check_table( $elementor_setting['translentor-default-language'], $lang_code );
						}
						   $lang_query->check_gettext_table( $lang_code );
					   }
						   
						   
					   $lang_query->check_original_table();
   $lang_query->check_original_meta_table();
   flush_rewrite_rules();
	}
