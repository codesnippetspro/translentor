...
class translentor_bottom_sheet extends \Elementor\Widget_Base
{
    ...
    {
        return 'translentor_bottom_sheet';
    }
    
    public function get_title()
    {
        return 'Translentor Bottom';
    }
    ...
    public function get_style_depends() 
    {
		...
		wp_register_style( 'translentor_bottom_sheet-css', translentor_URL . 'translentor/assets/css/translentor-translentor-bottom-sheet.min.css',
		array(),
		translentor_VERSION );
        return [ 'translentor_bottom_sheet-css' ];
    }  
    ...
    protected function tranlator_nav()
	{
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .ct-language__popup, {{WRAPPER}} .language_footer,{{WRAPPER}} .menu' => 'grid-template-columns: repeat({{SIZE}}, 1fr);',
				),
			)
		);
		$this->add_control(
    ...
    protected function register_general_controls()
    {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .ct-language__popup li,{{WRAPPER}} .language_footer li,{{WRAPPER}} .menu li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .ct-language__popup, {{WRAPPER}} .language_footer,{{WRAPPER}} .menu ' => 'top: {{TOP}}{{UNIT}};left: {{LEFT}}{{UNIT}};',
    ...
    protected function register_country_style_control()
    {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .ct-language__popup li, {{WRAPPER}} .language_footer li,{{WRAPPER}} .menu li' => 'background: {{VALUE}}',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'default' => '#ededed',
				'selectors' => array(
					'{{WRAPPER}} .ct-language__popup li:hover ,{{WRAPPER}} .language_footer li:hover,{{WRAPPER}} .menu li:hover' => 'background: {{VALUE}}',
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .ct-language__popup a,{{WRAPPER}} .language_footer a,{{WRAPPER}} .menu a' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .ct-language__popup a,{{WRAPPER}} .language_footer a,{{WRAPPER}} .menu a',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .ct-language__popup a:hover, {{WRAPPER}} .language_footer a:hover,{{WRAPPER}} .menu a:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .ct-language__popup a:hover,{{WRAPPER}} .language_footer a:hover,{{WRAPPER}} .menu a:hover',
			)
		);
    ...
    protected function register_dropdown_style_control()
    {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ct-language__popup li, {{WRAPPER}}.language_footer li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .ct-language__popup li,{{WRAPPER}} .language_footer li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .ct-language__popup::before,{{WRAPPER}} .language_footer::before' => 'top: {{BOTTOM}}{{UNIT}};right: {{LEFT}}{{UNIT}};bottom: {{TOp}}{{UNIT}};left: {{RIGHT}}{{UNIT}};',
				),
			)
		);
			$this->add_control(
			...
			array(
				...
				'default' => '#ededed',
				'selectors' => array(
					'{{WRAPPER}} .ct-language__popup::before, {{WRAPPER}} .language_footer::before' => 'border-bottom-color: {{VALUE}}',
				),
			)
		);
		$this->end_controls_section();
...
$this->add_render_attribute( 	'outer',
[
	'class' => [ 'font-system', 'column','fill', 'items-center' ,'justify-center' ],
] );
...
$this->add_render_attribute( 'overlay', 'class','overlay');
$this->add_render_attribute( 'contents', ['class'=>['contents','column']]);

$this->add_render_attribute( 'controls', 'class','controls');
$this->add_render_attribute( 'draggable-area', 'class','draggable-area');
$this->add_render_attribute( 'draggable-thumb', 'class','draggable-thumb');


		?>
		<div <?php echo $this->get_render_attribute_string( 'outer' ); ?>>
    <!-- Button to open a sheet -->
    <a <?php echo $this->get_render_attribute_string( 'opensheet' ); ?>><span
    ...
    <!-- The sheet component -->
    <div <?php echo $this->get_render_attribute_string( 'sheet' ); ?>>
      ...
      <div <?php echo $this->get_render_attribute_string( 'contents' ); ?>>
        <!-- Sheet controls -->
        <header <?php echo $this->get_render_attribute_string( 'controls' ); ?>>
          <!-- The thing to drag if you want to resize the sheet -->
          <div <?php echo $this->get_render_attribute_string( 'draggable-area' ); ?>>
            <div <?php echo $this->get_render_attribute_string( 'draggable-thumb' ); ?>></div>
          </div>
          <!-- Button to close the sheet -->
          <button <?php echo $this->get_render_attribute_string( 'closesheet' ); ?>>&times;</button>
        </header>
<?php
$this->add_render_attribute('fill',[
	'class'=>['content-body','fill','column'],

]);
$this->add_render_attribute('fluid',[
	'class'=>['row-fluid' ,'country-row'],
	'style'=>['overflow-y:scroll;','overflow-x:hidden;'],
]);
$this->add_render_attribute( 'containerCentered', 'class','containerCentered');
$this->add_render_attribute( 'span12', 'class','span12');
$this->add_render_attribute( 'countryselector', ['class'=>['country-selector', 'list-unstyled','ct-language__popup', 'vertical'],'style'=>'display: grid;',]);
$this->add_render_attribute( 'stilesnavalign', 'class','stiles-nav-align');

?>
        <!-- Body of the sheet -->
        <div <?php echo $this->get_render_attribute_string('fill');?>>
		<div <?php echo $this->get_render_attribute_string('fluid');?>>
			<div  <?php echo $this->get_render_attribute_string('containerCentered');?>>
			<div <?php echo $this->get_render_attribute_string('span12');?>>
  ...
  <?php
			 ...
			 $elementor_setting["translentor-lang-native-name"]= "english_name";
			 $elementor_setting["translentor-subdirectory-default-lang"]="no";
			 $elementor_setting['ip_detection_enabled']=$settings[ 'ip_detection_enabled' ];
			 $elementor_setting['detection_method']=$settings[ 'detection_method' ];
			 $elementor_setting['popup_option']=$settings[ 'popup_option' ];
			 $elementor_setting['popup_type']=$settings[ 'popup_type' ];
			 $elementor_setting['popup_textarea']=$settings[ 'popup_textarea' ];
			 $elementor_setting['popup_textarea_button']=$settings[ 'popup_textarea_button' ];
			 $elementor_setting['popup_textarea_close_button']=$settings[ 'popup_textarea_close_button' ];
  ...
  <?php if(get_option('google_translation')=='yes'){?>
...
const rowfluid=sheet.querySelector(".row-fluid")
...
const setSheetHeight = (value) => {
  ...
  rowfluid.style.height=`${sheetHeight}vh`
  if (sheetHeight === 100) {
...
Plugin::instance()->widgets_manager->register_widget_type( new translentor_bottom_sheet() );